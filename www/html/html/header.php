<header>
    ...
    <nav class="header-nav">
        <a id="cart-button" class="header-nav-link"><span class="material-icons">shopping_cart</span> Cart
            ...
            <nav class="header-login-dropdown-content">
                <div>
                    <div class="header-login-dropdown-flex">
                        <a id="login-button">Sign In <span class="material-icons"
                                style="font-size: 16px;">login</span></a>
                        <a id="register-button">Register <span class="material-icons"
                                style="font-size: 16px;">person_add</span></a>
                        <a id="orders-button">Orders<span class="material-icons"
                            style="font-size: 16px;">view_list</span></a>
                        <a id="preferences-button">Preferences <span class="material-icons"
